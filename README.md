...
## Table of Contents
- [Usage](https://github.com/ii887522/font-packer#usage)
- [Coding Style](https://github.com/ii887522/font-packer#coding-style)
- [Prerequisites](https://github.com/ii887522/font-packer#prerequisites)
- [Update .NET Framework SDK version used by ms-build-tools to match your OS](https://github.com/ii887522/font-packer#update-net-framework-sdk-version-used-by-ms-build-tools-to-match-your-os)
- [Build custom-node docker image](https://github.com/ii887522/font-packer#build-custom-node-docker-image)
- [Build ms-build-tools docker image](https://github.com/ii887522/font-packer#build-ms-build-tools-docker-image)
- [Install dependencies](https://github.com/ii887522/font-packer#install-dependencies)
- [Set correct cpplint executable path in .vscode/settings.json](https://github.com/ii887522/font-packer#set-correct-cpplint-executable-path-in-vscodesettingsjson)
- [Build project](https://github.com/ii887522/font-packer#build-project)
- [Deploy project](https://github.com/ii887522/font-packer#deploy-project)
...
[Build project](https://github.com/ii887522/font-packer#build-project) section to support you.
