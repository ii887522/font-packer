...
- [Coding Style](https://gitlab.com/ii887522/font-packer#coding-style)
- [Prerequisites](https://gitlab.com/ii887522/font-packer#prerequisites)
- [Update .NET Framework SDK version used by ms-build-tools to match your OS](https://gitlab.com/ii887522/font-packer#update-net-framework-sdk-version-used-by-ms-build-tools-to-match-your-os)
- [Build custom-node docker image](https://gitlab.com/ii887522/font-packer#build-custom-node-docker-image)
- [Build ms-build-tools docker image](https://gitlab.com/ii887522/font-packer#build-ms-build-tools-docker-image)
- [Install dependencies](https://gitlab.com/ii887522/font-packer#install-dependencies)
- [Set correct cpplint executable path in .vscode/settings.json](https://gitlab.com/ii887522/font-packer#set-correct-cpplint-executable-path-in-vscodesettingsjson)
- [Build project](https://gitlab.com/ii887522/font-packer#build-project)
- [Deploy project](https://gitlab.com/ii887522/font-packer#deploy-project)

## For developers reading this in GitHub
Please go to https://gitlab.com/ii887522/font-packer to start contributing instead.
...
[Build project](https://gitlab.com/ii887522/font-packer#build-project) section to support you.
