...
options.x86DllOutDirPaths = ['font-packer/Debug/', 'font-packer/Release/', 'font-packer/Test/'],
options.x64DllOutDirPaths = ['font-packer/x64/Debug/', 'font-packer/x64/Release/', 'font-packer/x64/Test/']
const accessToken = 'iUQ1SFJfBq4sKQ6TaQd9'
...
dependencies(async () => {
  await Promise.all([
    ...
    zip('https://gitlab.com/api/v4/projects/23530641/packages/generic/nitro/1.1.0/nitro-1.1.0.zip', { 'PRIVATE-TOKEN': accessToken }),
    zip('https://gitlab.com/api/v4/projects/23074770/packages/generic/viewify/1.2.10/viewify-1.2.10.zip', { 'PRIVATE-TOKEN': accessToken })
  ])
